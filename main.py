...
#RUNNING ANALYSIS ARGUMENTS
        ...
        tend= int(time.time() - stime)
        elapsedtime = "{:02d}:{:02d}:{:02d}".format(tend // 3600, (tend % 3600 // 60), tend % 60)
        bc_end = "\nAnalysis complete. The analysis took {time} to complete.".format(time=elapsedtime)
        print(bc_end)
